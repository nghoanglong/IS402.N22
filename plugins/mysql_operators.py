...
from support_processing import SupportProcessing
import logging
from contextlib import closing
import os

class MySQLOperators:
    def __init__(self, conn_id="mysql_dbwh_staging"):
        try:
    ...
    def insert_dataframe_into_table(self, table_name, dataframe, data):
        ...
        query = SupportProcessing(dataframe, table_name).create_query_insert_into()
        try:
            ...
            logging.ERROR(f"cant execute {execute_query}")
